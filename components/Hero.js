                ...
                <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    ...
                    <img
                      ...
                      alt=""
                    /> */}
                      <h1 className="text-white font-extrabold tracking-tight text-md sm:text-2xl">
                        Fresh-tech-talents
                      </h1>
                    </a>
                  </div>
                ...
                <div className="md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0 space-x-4">
                  <span className="inline-flex rounded-full shadow">
                    <Link href="/talent-signin">
                      <a className="inline-flex items-center px-3 py-1 text-sm sm:px-6 sm:py-2 sm:text-base border border-transparent font-bold rounded-full text-zinc-50 hover:text-green-400 hover:underline  focus:outline-none focus:ring-2 focus:ring-offset focus:ring-green-500">
                        Sign in
                      </a>
                    </Link>
                  </span>
            ...
            <div className="text-center">
              <h1 className="text-3xl tracking-tight font-extrabold text-zinc-50 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">
                  Find rising tech talents
                </span>{" "}
                <span className="block text-transparent bg-clip-text bg-gradient-to-br from-green-500 to-green-400 xl:inline">
                  open to work.
                </span>
              </h1>
              ...
              <div className="mt-4 max-w-md mx-auto sm:flex sm:justify-center md:mt-16">
                <div className="rounded-full shadow">
                  <Link href="/talent-signin">
                    <a className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-bold rounded-full text-zinc-900 bg-gradient-to-br from-green-500 to-green-400 md:py-2 md:text-lg md:px-8 shadow-lg shadow-zinc-200/20 hover:shadow-lg hover:shadow-zinc-200/50">
                      I am a talent
                    </a>
                  </Link>
                </div>
