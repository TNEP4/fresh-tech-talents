...
export default function Profile() {
  ...
  const [interests, setInterests] = useState({ interests: "Loading" });
    ...
    <div className="mx-1 rounded-sm flex flex-row shadow-lg shadow-zinc-400/10 border border-zinc-800/20">
      ...
      <div className="p-3 sm:p-6 text-zinc-100 w-full space-y-3">
          ...
          <div className="flex flex-row w-full ">
            <div className="flex flex-col w-full h-full justify-between">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-green-400 underline underline-offset-1 font-medium"
              >
                {portfolioUrl}
              </a>
              <p>{bio}</p>
        ...
        <div>
          ...
          <p>
            <span className="text-zinc-400">Based in: </span> {location}
          </p>
          <p>
          ...
          <p>
            <span className="text-zinc-400">Prefers: </span>
            {prefers[0]}, {prefers[1]}, {prefers[2]}
          </p>
          <p>
            <span className="text-zinc-400">Speaks: </span>
